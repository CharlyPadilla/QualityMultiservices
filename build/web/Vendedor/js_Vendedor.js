                ...
                data.forEach(function (cliente) {
                    ...
                    <div class="card col-md-6 mb-4 mx-auto position-relative">
                        ...
                        <button type="button" class="btn btn-custom position-absolute top-0 end-0 me-3 mt-3 d-none d-md-block" data-bs-toggle="modal" data-bs-target="#myModal">
                            <img src="btnEditar.png" alt="Botón con Imagen">
                        </button>

                        <div class="card-body text-center">
                            <h1>Perfil de Usuario</h1>
                            <br>
                            <img class="profile-pic rounded-circle mx-auto d-block mb-3" src="${imagenPerfil}" alt="Foto de Perfil" width="150" height="150">
                            <h2>${nombreUsuario}</h2>
                            <div class="card-body text-center">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="imagenPerfil" name="imagenPerfil" placeholder="Ingrese la nueva imagen de perfil (URL)">
                                        </div>
                                        <div class="mb-3">
